class BannersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @banner.update(banner_params)
        format.html { redirect_to @banner, notice: "Banner was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to banners_path, notice: "Banner was successfully destroyed.", status: :see_other }
